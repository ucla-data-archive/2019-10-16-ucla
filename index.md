...
address: "Powell Library, 10740 Dickson Ct, Los Angeles, CA 90095"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "34.0716126,-118.4421809"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Oct 16-17 & 23-24, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Deidre Whitmore", "Jamie Jamison", "Kristian Allen", "Leigh Phan", "Tim Dennis"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Geno Sanchez", "Mark Matney", "Christine Wells", "Dave George"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-10-ucla      # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
{% endif %}
<h2>Register</h2>
<!-- Place the following link anywhere in your page. Make sure the id "s_lc_event_5870745" matches with the above code: jQuery("#s_lc_event_5870745")  //-->
<a id="s_lc_event_5870745" href="https://calendar.library.ucla.edu/event/5870745">CLICK AND REGISTER</a>
